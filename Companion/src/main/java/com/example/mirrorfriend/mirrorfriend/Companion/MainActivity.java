...
public class MainActivity extends AppCompatActivity {
    ...
    String pLat, pLng, txtSize, tColor, bColor;
    ...
    public void startBTConnection(BluetoothDevice device, UUID uuid) {
        mBlue2.startClient(device, uuid);
    }

    public boolean checkLocationPermission() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{permission.ACCESS_FINE_LOCATION}, MY_PERMISSIONS_REQUEST);
            return false;
        } else {
            return true;
        }
    ...
    public boolean checkBluetoothPermission() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{permission.BLUETOOTH}, MY_PERMISSIONS_REQUEST);
            return false;
        } else {
            return true;
        }
    ...
    public boolean checkBluetoothAdminPermission() {
        if (ActivityCompat.checkSelfPermission(this, permission.BLUETOOTH_ADMIN) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{permission.BLUETOOTH_ADMIN}, MY_PERMISSIONS_REQUEST);
            return false;
        } else {
            return true;
        }
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ContextCompat.checkSelfPermission(this, permission.BLUETOOTH);
    ...
    public class refresh extends TimerTask {
        public void run() {
            ...
            mBlue2.write(byteLat);
            mBlue2.write(byteLng);
            mBlue2.write(byteSize);
            mBlue2.write(byteTC);
            mBlue2.write(byteBGC);
        }
    }
